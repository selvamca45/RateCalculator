//
//  DropDownJobLevelViewController.swift
//  CiberRateCalculator
//
...
class DropDownJobLevelViewController: UIViewController, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let nib = UINib(nibName: "DropDownJobLevelTableViewCell", bundle: nil)
        dropDownListView.register(nib, forCellReuseIdentifier: "DropDownJobLevelTableViewCell")
    ...
    func  doneButtonClicked(){
        if selectedModelIdArray.count == 0 {
            let alert = UIAlertController(title: "", message: "Please select a job level to proceed", preferredStyle: .alert)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell = tableView.dequeueReusableCell(withIdentifier: "DropDownJobLevelTableViewCell", for: indexPath) as! DropDownJobLevelTableViewCell
        if cell == nil {
            cell = DropDownJobLevelTableViewCell(style: UITableViewCell.CellStyle.default, reuseIdentifier: "DropDownJobLevelTableViewCell")
        }
